...
@section('content')
    <div class="content-header header-shop">
        ...
        <ul class="nav nav-tabs filter-group-title" id="myTab" role="tablist">
            <li class="nav-item active" role="presentation">
                <a class="nav-link active" id="qrProfile" data-bs-toggle="tab" data-bs-target="#qrProfile-pane" type="button" role="tab" aria-controls="qrProfile-pane" aria-selected="true">
                    QR Profile
                </a>
            </li>
    ...
    <div class="content">
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane show active" id="qrProfile-pane" role="tabpanel" aria-labelledby="qrProfile" tabindex="0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" placeholder="nội dung mô tả chi tiết..." rows="5"></textarea>
                                    </div>
                                </div>
            ...
            <div class="tab-pane" id="qrShop-pane" role="tabpanel"  aria-labelledby="qrShop" tabindex="0">
                <div class="block-content QR_profile">
                    <div class="title">
                        <div class="row m-0 align-items-center">
                            <div class="col-6">
            ...
            <div class="tab-pane" id="qrOption-pane" role="tabpanel" aria-labelledby="qrOption" tabindex="0">
                <div class="block-content QR_profile">
                    <div class="title">
                        <div class="row m-0 align-items-center">
                            <div class="col-6">
