...
@section('content')
    <div class="content-header header-shop">
        ...
        <ul class="nav nav-tabs filter-group-title" id="myTab" role="tablist">
            <li class="nav-item {{ Request::url() == route('shops.create') ? "active" : ""}}"
                role="presentation">
                <a class="nav-link {{ Request::url() == route('shops.create') ? "active" : ""}}"
                   id="home" href="{{route('shops.create')}}" data-bs-toggle="tab"
    ...
    <div class="content">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane {{ Request::url() == route('shops.create') ? "active show" : ""}}"
                                                ...
                                                <div class="title">
                                                    <div class="row m-0 align-items-center">
                                                        ...
                                                        <div class="col-4 text-end">
                                                            <div class="add-new">
                                                                <a href="{{url('sites/aaa/edit/1')}}"
                                                                   class="btn btn1 text-center">
                                                                    <p>Chỉnh sửa</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="user-block text-center col-12">
                                                                ...
                                                                <label for="uploadProfilePicture">
                                                                    <img id="img_show" width="200"
                                                                         src=""
                                                                         alt=""/>
                                                                    <input type="hidden" name="configs[avatar]" value=""
                                                                           id="thumb">
                                                            ...
                                                            <div class="form-group col-12">
                                                                ...
                                                                <input type="text" class="form-control" id="phone"
                                                                       name="phone"
                                                                       placeholder="Nhập phone number của bạn..."
                                                                       required/>
                                                            </div>
                                                            <div class="form-group col-12">
                                                            ...
                                                            <div class="form-group col-6">
                                                                <input type="text"
                                                                       ...
                                                                       required/>
                                                                <span class="icon">
                                        <img src="{{asset('web/images/facebook.png')}}" alt=""/>
                                    </span>
                                                            </div>
                                                            <div class="form-group col-6">
                                                                <input type="text"
                                                                       ...
                                                                       placeholder="đường dẫn Tiktok..." required/>
                                                                <span class="icon">
                                        <img src="{{asset('web/images/tiktok.png')}}" alt=""/>
                                    </span>
                                                            </div>
                                                            <div class="form-group col-6">
                                                                <input type="text"
                                                                       class="form-control input-group-icon"
                                                                       id="youtube" name="configs[youtube]"
                                                                       placeholder="đường dẫn Youtube..." required/>
                                                                <span class="icon">
                                        <img src="{{asset('web/images/youtobe.png')}}" alt=""/>
                                    </span>
                                                            </div>
